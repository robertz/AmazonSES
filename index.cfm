...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style>
			BODY { font-family: arial; font-size: 12px; } .hidden { display: none; } td.emailLabel { text-align: right; font-weight: bold; padding-right: 8px; height: 30px; } #mailQuota { border: 1px solid black; line-height: 24px; font-weight: bold; padding: 4px; margin-bottom: 8px; } #apiStatusReport { border: 1px solid black; font-weight: bold; padding: 4px; margin-bottom: 8px; } .apiSuccess { background-color: #CCCCFF; } .apiFail { background-color: #F00; } #mainForm { border: 1px solid black; padding: 4px; margin-bottom: 8px; background-color: #e6e2d4; } #navSections { border: 1px solid black; padding: 4px; margin-bottom: 8px; } .navButton { width: 125px; align: center; } 
		</style>
	</head>
	<body>
		<cfscript>
		...
		<cfoutput>
			<div style="width: 800px;">
				<div id="mailQuota">
					You have sent #sendQuota.getSentLast24Hours# of #sendQuota.max24HourSend# messages in the last 24 hours. #sendQuota.max24HourSend - sendQuota.getSentLast24Hours# messages remain. Max send rate is #sendQuota.getMaxSendRate#. 
				</div>
				...
				<div id="mainForm">
					<form id="message" method="post">
						...
						<div id="formMessageContainer">
							<table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
								<tr>
									<td class="emailLabel" valign="middle">
										From
									</td>
									<td valign="middle">
										<cfif arrayLen(vList)>
								...
								<tr>
									...
									<td valign="middle">
										<input type="text" name="to" value="#form.to#" style="width: 60%;">
									</td>
								</tr>
								<tr>
									<td class="emailLabel" valign="middle">
									...
									<td valign="middle">
										<input type="text" name="replyTo" value="#form.replyTo#" style="width: 60%;">
									</td>
								</tr>
								<tr>
									<td class="emailLabel" valign="middle">
									...
									<td valign="middle">
										<input type="text" name="cc" value="#form.cc#" style="width: 60%;">
									</td>
								</tr>
								<tr>
									<td class="emailLabel" valign="middle">
									...
									<td valign="middle">
										<input type="text" name="bcc" value="#form.bcc#" style="width: 60%;">
									</td>
								</tr>
								<tr>
									<td class="emailLabel" valign="middle">
									...
									<td valign="middle">
										<input type="text" name="subject" value="#form.subject#" style="width: 94%;">
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<textarea name="messageBody" rows="10" style="width: 95%;">
											#form.messageBody#
										</textarea>
									</td>
								</tr>
						...
						<div id="formManageEmails" class="hidden">
								...
								<cfloop from="1" to="#arrayLen(verifiedSenders.verifiedList)#" index="n">
									<tr>
										<td style="width: 175px; height: 24px;">
											<input type="button" onclick="removeSender('#verifiedSenders.verifiedList[n]#');" value="Remove Address" />
										</td>
										<td valign="center">
											#verifiedSenders.verifiedList[n]#
										</td>
									</tr>
								</cfloop>
							</table>
							...
							<table cellpadding="0" cellspacing="0" style="width: 100%;">
								<tr>
									<td style="width: 100px; height: 24px; padding-right: 8px;" align="right">
										<strong>
											Add Email
										</strong>
									</td>
